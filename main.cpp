...
int main(void)
{
	//coutとendlの間に入れることで表示
	std::cout << "整列前の配列を表示" << std::endl;
	//forで回して上記と同様にcoutとendlで表示
